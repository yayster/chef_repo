...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "yayster-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/yayster"
  #   chef.validation_client_name = "yayster-validator"
  #   chef.validation_key_path = ".chef/yayster-validator.pem"
  # end
end
